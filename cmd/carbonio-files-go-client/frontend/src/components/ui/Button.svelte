<script>
  ...
  // Mirrors the original .btn-primary { width: 100% } default, overridden
  // to auto-width for buttons living in an actions row (see callers).
  // Secondary buttons are always auto-width, matching the original CSS.
